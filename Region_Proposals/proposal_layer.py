# Got help from https://github.com/hxuaj/tf2-faster-rcnn/blob/main/model/layer/proposal_layer.py
...
class proposal_layer(layers.Layer):
    ...
    def call(self, rpn_cls_prob, rpn_bbox_pred, anchors, img_size):
        ...
        proposals = bbox_transform.delta2bbox(anchors_sorted, rpn_bbox_pred_sorted)
        proposals = bbox_transform.clip_to_boundary(proposals, img_size)
